...
describe('routeIntent', () => {
  ...
  it('routes AdministrativeAction with high confidence and requires confirmation', async () => {
  ...
  it('returns clarification for ambiguous AdministrativeAction with low confidence', async () => {
