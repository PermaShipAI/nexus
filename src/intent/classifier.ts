...
- AdministrativeAction: User wants to enable/disable a system setting, toggle a mode, or change a configuration parameter (e.g., autonomous mode, log level, rate limiting)
