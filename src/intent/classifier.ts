...
- AdministrativeAction: User wants to toggle or change a system setting (e.g., enable/disable autonomous mode, configure features). Extract settingKey and settingValue params. If either cannot be definitively determined, set confidenceScore below 0.6.
