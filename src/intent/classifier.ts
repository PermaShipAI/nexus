...
- AdministrativeAction: User wants to change a system setting or toggle an operational mode (e.g., autonomous mode, public mode). Extract settingKey and settingValue into params.
