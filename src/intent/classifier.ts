...
- AdministrativeAction: User wants to toggle system settings or autonomous mode (e.g., enable/disable autonomous mode, pause agents, change execution backend). Use a low confidenceScore (< 0.6) if the settingKey or settingValue cannot be definitively extracted.
