...
- **agentDiscussionContext**: A synthesized prose summary of the agent discussion that motivated this ticket (max 1500 chars). Synthesize key points — do NOT paste raw conversation transcripts. Exceeding this limit will AUTOMATICALLY REJECT your proposal with a validation error requiring condensed resubmission.
...
- **agentDiscussionContext** (optional): Synthesized prose summary of agent discussion relevant to this ticket. Max 1500 characters. Do NOT paste raw transcripts — synthesize key points only. Exceeding this limit will AUTOMATICALLY REJECT your proposal.
