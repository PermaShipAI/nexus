...
export type GuardrailEvent =
  ...
  | { event: "discussion_context_too_long"; orgId: string; agentId: string; title: string; length: number }
  | { event: "ticket_proposal_transcript_rejected_total"; orgId: string; agentId: string; title: string }
