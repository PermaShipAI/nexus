...
export type GuardrailEvent =
  ...
  | { event: "administrative_intent_confirmation_displayed"; channelId: string; userId: string; confirmationId: string; settingKey: string; settingValue: string }
  | { event: "administrative_intent_executed"; channelId: string; userId: string; confirmationId: string; settingKey: string; settingValue: string; elapsedMs: number };
