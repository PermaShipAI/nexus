...
export type GuardrailEvent =
  ...
  | { event: "administrative_intent_clarification_triggered"; intent: string; channelId: string; userId: string; confirmationId: string; settingKey?: string; settingValue?: string };
