...
export type GuardrailEvent =
  ...
  | { event: 'ux_admin_intent_confirmation_displayed'; intent: string; channelId: string; userId: string; confirmationId: string }
  | { event: 'administrative_intent_clarification_triggered'; channelId: string; userId: string; confidenceScore: number; messageId: string };
